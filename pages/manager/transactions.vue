<template>
  ...
  async function inviteUser() {
    ...
    try {
      const response = await axios.post('https://mindbostapi.dowhf.com/api/transactions', {
        email: email.value,
  ...
  async function fetchSubscriptions() {
    try {
      const response = await axios.post('https://mindbostapi.dowhf.com/api/pending-invitations', {
